...
Add-UIBanner -Step 'Identity' -Type 'info' `
...
Add-UIBanner -Step 'Resources' -Type 'info' `
...
Add-UIBanner -Step 'Storage' -Type 'info' `
...
Add-UIBanner -Step 'Networking' -Type 'info' `
...
Add-UIBanner -Step 'Options' -Type 'info' `
...
Add-UIBanner -Step 'Review' -Type 'info' `
